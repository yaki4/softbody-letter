...
export default class FboHelper {
    ...
    init(renderer, floatType) {
        ...
        const debugPlane = new THREE.PlaneGeometry(1, 1);

        debugPlane.translate(.5, -.5, 0)
        ...
        this._debugMesh = new THREE.Mesh(debugPlane, this._debugMaterial)
