...
import { GameMaterial } from "../Materials/GameMaterial.js";
...
export default class Grass {
    ...
    InitEntity() {
        this.#grassMaterialLow_ = new GameMaterial('GRASS')
        this.#grassMaterialHigh_ = new GameMaterial('GRASS')

        // this.#grassMaterialLow_ = new THREE.MeshStandardMaterial({
        //    color: 0x00ff00,
        // });
        // this.#grassMaterialHigh_ = new THREE.MeshStandardMaterial({
        //     color: 0xff0000,
        // });
