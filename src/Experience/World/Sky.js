...
import View from '../Experience.js'
...
export default class Sky
{
    constructor()
    {
        ...
        this.view = new Experience()
        this.state = State.getInstance()
        //this.debug = Debug.getInstance()

        this.viewport = this.experience.sizes
    ...
    setStars()
    {
        ...
        this.stars.material.uniforms.uHeightFragments.value = this.viewport.height * this.viewport.pixelRatio
